...
struct Light : public ILight {
  ...
  private:
    ...
    std::ofstream mRedDelayOff;
    std::ofstream mGreenDelayOff;
    std::ofstream mBlueDelayOff;
    std::ofstream mRedDelayOn;
    std::ofstream mGreenDelayOn;
    std::ofstream mBlueDelayOn;

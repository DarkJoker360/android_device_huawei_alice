...
echo "Patching bionic/libc/bionic....."
cd bionic/libc/bionic
git remote add gps https://github.com/DarkJoker360/android_bionic
git fetch gps
git cherry-pick 05f2b6707a50edbf1cd60dee1b107992b42964b0
...
git fetch bt
git cherry-pick 46c163e13dbe21476e3fe8e2f94ae10af28f2c5c
...
git fetch hwc
git cherry-pick a083e29978432dfc04039a224c82925cbcab780f
...
git fetch sim
git cherry-pick 79b503f625a7c0a048f9c891e19cc6be4b2f0e57
...
echo "Patching packages/apps/Updater....."
cd ..
cd Updater
git remote add ota https://github.com/DarkJoker360/android_packages_apps_Updater
git fetch ota
git cherry-pick 362163f15ba1d5db1a1cb92a5a8a9b3b1364eaeb
cd ../../..
